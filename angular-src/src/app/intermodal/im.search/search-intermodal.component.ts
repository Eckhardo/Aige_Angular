...
import {IntermodalSearchFrom} from './search-intermodal.component.form';
...
export class SearchIntermodalComponent {
  ...
  formClass: IntermodalSearchFrom;
  ...
  constructor(private enumService: EnumService, private countryService: CountryService,
    ...
    this.formClass = new IntermodalSearchFrom();
    this.searchFormIntermodal = this.formClass.searchIntermodalForm;
