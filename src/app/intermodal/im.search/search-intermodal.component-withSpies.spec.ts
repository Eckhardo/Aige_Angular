...
describe('SearchRoutesComponent: Simulate autocomplete for Country', () => {
  ...
  it('Call CountryService#filterCountries with Jasmine Spy & fakeAsync', fakeAsync(() => {
    spyOn(countryService, 'filterCountries').and.returnValue(Observable.of(singleCountryStub));
    ...
    fixture.whenStable().then(() => {
      ...
      expect(countryService.filterCountries).toHaveBeenCalledTimes(2);
      expect(countryService.filterCountries).toHaveBeenCalledWith('D');
